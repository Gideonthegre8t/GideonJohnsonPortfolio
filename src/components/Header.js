...
window.open(cvUrl, '_blank')
  ...
  return(
    ...
    <div className="header-content">
     <h2><span>Hello, I'm Gideon,</span> frontend developer</h2>
     <p>UI/3D Animator seeking to apply competent development skills with focus and collaboration , communitcation and passion</p>
